...
number = input("masukan nomor tujuan : ") #ini adalah pemasukan nomor anda bisa mengubah terserah kalian asal jangan ubah yang tidak teks berwarna hijau
...
for i in range(number): #ini pemasukan pesan yang di ingin jika kamu ubah angka 1 sama 2 maka akan masuk pesan 2x
